package com.example.amazonclone.MenuFile;
        ...
        profileHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (setImageUri != null) {
                    ...
                    String imgUri = "https://firebasestorage.googleapis.com/v0/b/clone-f7b47.appspot.com/o/profilepicicon.jpg?alt=media&token=1c0a1dea-9ad3-44bd-b39f-e74d0d0779fd";
